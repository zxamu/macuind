...
<nav class="h-16 bg-gradient-to-r from-indigo-900 to-cyan-300">
  <div class="max-w-screen-xl flex items-center justify-between mx-auto px-4 pt-3">
    ...
    <div class="hidden md:flex md:items-center md:space-x-8">
      ...
      <a href="/tickets_auxiliar" class="block py-2 text-white rounded hover:bg-transparent hover:text-blue-700">Tickets</a>
     ...
     <!-- imagen avatar -->
      <img class="w-10 h-10 rounded-full" src="images/auxiliar.png" alt="Rounded avatar">
      </button>
    </div>
...
<div id="userDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
    <div class="px-4 py-3 text-sm text-gray-900 dark:text-white">
        <div>Alejandro Suárez</div>
        <div class="font-medium truncate">alejandro.suarez@macuin.com</div>
    </div>
